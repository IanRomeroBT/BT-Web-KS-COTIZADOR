...
def static "Utilidades.CustomSelect"(
    	TestObject select	
     , 	String optionLabel	
     , 	boolean selectInIframe	) {
    (new Utilidades()).CustomSelect(
        	select
         , 	optionLabel
         , 	selectInIframe)
}
...
def static "Utilidades.EscribirExcel"(
    	String nombreExcel	
     , 	String nombreHoja	
     , 	int fila	
     , 	int columna	
     , 	String dato	) {
    (new Utilidades()).EscribirExcel(
        	nombreExcel
         , 	nombreHoja
         , 	fila
         , 	columna
...
def static "Utilidades.ObtenerValorExcel"(
    	String nombreExcel	
     , 	String nombreHoja	
     , 	int fila	
     , 	int columna	) {
    (new Utilidades()).ObtenerValorExcel(
        	nombreExcel
         , 	nombreHoja
         , 	fila
         , 	columna)
...
def static "Utilidades.ObtenerIndexUltimoRegistro"(
    	String nombreExcel	
     , 	String nombreHoja	
     , 	int columna	) {
    (new Utilidades()).ObtenerIndexUltimoRegistro(
        	nombreExcel
         , 	nombreHoja
         , 	columna)
}
...
def static "Utilidades.obtenerDatosEscenario"(
    	String nombreEscenario	) {
    (new Utilidades()).obtenerDatosEscenario(
        	nombreEscenario)
}
