...
CustomKeywords.'Utilidades.CustomSelect'(findTestObject('COTIZADOR_SEGURO/DatosSeguro/div_formaPago'), tipoPago, false)
...
if (seguro.contains('choices-disabled') == false) {
    ...
    WebUI.sendKeys(findTestObject('COTIZADOR_SEGURO/DatosSeguro/input_sumaAsegurada'), Keys.chord(Keys.CONTROL + 'A') + sumaAsegurada.toString() + Keys.chord(Keys.TAB))
...
WebUI.click(findTestObject('COTIZADOR_SEGURO/Globales/button_cotizar'))
